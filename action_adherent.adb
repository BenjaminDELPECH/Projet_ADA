       ...
       for I in 1..Choixadh-1 loop
          Tmp5:=Tmp5.Suiv;
               ...
               loop
                  ...
                  new_line;
                  put("Veuillez sÈlectionner le numÈro d'un jour valide ");
                  new_line;
                  exception
                     ...
                     loop
                        begin
                           ...
                           new_line;
                           put("SÈlectionnez un chiffre valable pour le crÈneau"); new_line;
                           exception
                     ...
                     if Tmp5.Adherent.Planingsemaine2(ChoixJour)(Choixhoraire).Present = True then new_line;Put_line("Vous avez une reservation ‡ ce creneau, SOUHAITEZ VOUS ANNULER?");
                        new_line;
                        Put_line("1=>OUI");
                        Put_line("2=>NON");
                        new_line;
      ...
      if(tmp2.Adherent.Typecontrat=Aquaetfitness and
         ...
         loop
            begin
               ...
               new_line;
               put("Saisissez un chiffre proposÈ "); 
               new_line;
               exception
                     when data_error=>skip_line;
                     put("Erreur, veuillez recommencer la saisie "); new_line;
         ...
         Put("Pas de creneau disponible ‡ cet horaire");
      end if;
 ...
 --Choix d'un jour
   ...
   begin
      ...
      if Tmp /= null then
         ...
         new_line;
         put ("Entrer le numÈro de l'adhÈrent : ");
         loop
            begin
               Get(Choixadh);
               Skip_Line; 
